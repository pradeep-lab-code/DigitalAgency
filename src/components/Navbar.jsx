...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/90"
    >
      <img
        src={theme === "dark" ? assets.logo_dark : assets.logo}
        className="pl-10 h-16 w-auto object-contain"
      />
      <div
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <a
          href="#contact-us"
          className="text-sm max-sm:hidden flex items-center gap-2 bg-primary  text-white px-6 py-3 rounded-full cursor-pointer hover:scale-105 transition-all duration-300"
        >
          Connect
