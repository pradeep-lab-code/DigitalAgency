...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    w-72 h-72 absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? "opacity-70" : "opacity-0"}`}
        style={{ top: position.y - 150, left: position.x - 150 }}
      />

      <div className="flex items-center gap-10 p-8 hover:scale-95 transition-all duration-300 rounded-[10px] bg-white dark:bg-gray-900 z-10 relative">
        <div className="bg-gray-700 dark:bg-gray-700 rounded-full">
          <img
            src={service.icon}
            alt=""
